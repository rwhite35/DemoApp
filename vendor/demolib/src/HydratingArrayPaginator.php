...
namespace DemoLib;
/**
 * Paginated API transaction data (by UUID)
 * 
 * Take the transaction data and hydrated an array.
 * the prototype fields are defined Entity object and data/demolib.php The Entity
 * defines what the endpoint expects as input.  The data/demolib defines when and what.
 * 
 * Uses specialized Zend\Paginator\Adapter\ArrayAdapter instance for returning request input.
 */
