...
/**
 * This is the config file for ZfrCors. This file requires ZfrCors 
 * enabled for dev and prod and lives in /vendor/zfr/config.
 */
...
return [
    'zfr_cors' => [
         ...
         /**
          * Set the list of headers the service expects to be passed in. 
          * This is returned in the preflight request to indicate
